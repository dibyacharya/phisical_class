...
\title{\textbf{EduCampus: A Low-Cost Android-TV-First Automated Lecture Capture System with Multi-Campus Hierarchy Management}}
...
EduCampus comprises four main components, as illustrated in Figure~\ref{fig:arch}.
...
+-------------------+   +-----------------------+
\end{lstlisting}
\caption{EduCampus system architecture.}
\label{fig:arch}
\end{figure}
...
\textbf{The contribution:} A license activation scheme where a generated key (\texttt{EDUC-XXXX-XXXX-XXXX}) is cryptographically bound to a device's MAC address on first registration. The same APK/EXE cannot be used to register a second physical device.
...
Table~\ref{tab:comparison} summarises EduCampus against the five major existing platforms across key dimensions.

\begin{table}[H]
\centering
\caption{Feature comparison: EduCampus vs existing lecture capture platforms (April 2026)}
\label{tab:comparison}
\small
\begin{tabular}{lcccccc}
\toprule
\textbf{Feature} & \textbf{Panopto} & \textbf{Echo360} & \textbf{Kaltura} & \textbf{YuJa} & \textbf{Opencast} & \textbf{EduCampus} \\
\midrule
...
\textbf{EduCampus + Android TV box} & \textbf{INR 2{,}000--10{,}000} & \textbf{Target: INR 6{,}000--24{,}000} \\
\bottomrule
\end{tabular}
\end{table}
...
EduCampus is operational as of April 2026:
...
With 52{,}321 colleges and 1{,}355 universities in India, and an estimated 90\% unable to afford Western enterprise pricing, EduCampus targets a large, underserved, and rapidly growing market.

% ─────────────────────────────────────────────────────────────────────────────
\section{Future Work}
% ─────────────────────────────────────────────────────────────────────────────

EduCampus is part of a broader ecosystem under development at D\&R AI Solutions Pvt.\ Ltd.:

\begin{itemize}
    \item \textbf{Univanta LMS} — A full Learning Management System with AI-powered transcription, student mobile application, course management, and engagement analytics. EduCampus recordings are designed to feed directly into Univanta LMS course content.
